...
class BalanceSheet < ApplicationRecord
  ...
  MAP = {
    ...
    cash_and_short_term_investments: { text: 'Cash & Short-Term Investments' },
    net_receivables: { text: 'Net Receivables' },
    inventory: { text: 'Inventory' },
    other_current_assets: { text: 'Other Current Assets' },
    total_current_assets: { text: 'Total Current Assets', bold: true },
    property_plant_equipment_net: { text: 'PP&E', tooltip: 'Property Plant Equipment Net' },
    goodwill: { text: 'Goodwill' },
    intangible_assets: { text: 'Intangible Assets' },
    goodwill_and_intangible_assets: { text: 'Goodwill & Intangible Assets' },
    long_term_investments: { text: 'Investments', tooltip: 'Long Term Investments' },
    ...
    total_assets: { text: 'Total Assets', bold: true, highlight: true },
    account_payables: { text: 'Account Payable' },
    short_term_debt: { text: 'Short-Term Debt' },
    tax_payables: { text: 'Tax Payable' },
    deferred_revenue: { text: 'Deferred Revenue' },
    other_current_liabilities: { text: 'Other Current Liabilities' },
    total_current_liabilities: { text: 'Total Current Liabilities', bold: true },
    long_term_debt: { text: 'Long-Term Debt' },
    deferred_revenue_non_current: { text: 'Deferred Revenue', tooltip: 'Deferred Revenue Non Current' },
    deferred_tax_liabilities_non_current: { text: 'Deferred Tax Liabilities',
                                            tooltip: 'Deferred Tax Liabilities Non Current' },
    ...
    total_liabilities: { text: 'Total Liabilities', bold: true, highlight: true },
    preferred_stock: { text: 'Preferred Stock' },
    common_stock: { text: 'Common Stock' },
    retained_earnings: { text: 'Retained Earnings' },
    accumulated_other_comprehensive_income_loss: { text: 'Other Compreh. Income(Loss)',
                                                   tooltip: 'Accumulated Other Comprehensive Income Loss' },
    othertotal_stockholders_equity: { text: 'Other Total Stockhold. Equity' },
    total_stockholders_equity: { text: 'Total Stockholders Equity', bold: true },
    # total_equity: { text: 'Total Equity' },
    total_liabilities_and_stockholders_equity: { text: 'Total Liab.& Stockhold. Equity',
                                                 tooltip: 'Total Liabilities & Stockholders Equity' },
    minority_interest: { text: 'Minority Interest' },
    total_liabilities_and_total_equity: { text: 'Total Liabilities And Equity' }
