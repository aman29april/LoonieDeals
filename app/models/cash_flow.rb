...
class CashFlow < ApplicationRecord
  ...
  MAP = {
    ...
    accounts_receivables: { text: 'Accounts Receivable' },
    inventory: { text: 'Inventory' },
    accounts_payables: { text: 'Accounts Payable' },
    other_working_capital: { text: 'Other Working Capital' },
    other_non_cash_items: { tooltip: 'Other Non-Cash Items', bold: true },
    net_cash_provided_by_operating_activities: { text: 'Cash by Operating Activities',
                                                 tooltip: 'Net Cash Provided By Operating Activities' },
    investments_in_property_plant_and_equipment: { text: 'CAPEX',
                                                   tooltip: 'Investments In Property Plant And Equipment' },
    ...
    net_cash_used_for_investing_activites: { text: 'Cash Used for Investing Activities',
                                             tooltip: 'Net Cash Used For Investing Activites', bold: true },
    ...
    net_cash_used_provided_by_financing_activities: { text: 'Cash Used/Provided by Financing Activities',
                                                      tooltip: 'Net Cash Used Provided By Financing Activities', bold: true },
    effect_of_forex_changes_on_cash: { text: 'Effect Of Forex Changes On Cash' },
    net_change_in_cash: { text: 'Net Change In Cash', bold: true },
    cash_at_end_of_period: { text: 'Cash At End Of Period' },
    cash_at_beginning_of_period: { text: 'Cash At Beginning Of Period' },
    operating_cash_flow: { text: 'Net Cash FLow', tooltip: 'Operating Cash Flow' },
    # capital_expenditure: { text: 'Capital Expenditure' },
    free_cash_flow: { text: 'Free Cash Flow', bold: true }
  }.freeze
