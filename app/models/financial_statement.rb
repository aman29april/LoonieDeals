...
class FinancialStatement < ApplicationRecord
  ...
  MAP = {
    ...
    selling_general_and_administrative_expenses: { text: 'Selling, G&A Expenses',
                                                   tooltip: 'Selling, General and Administrative Expense' },
    ...
    total_assets: { text: 'Total Assets', highlight: true },
    ...
    total_liabilities: { text: 'Total Liabilities', highlight: true },
