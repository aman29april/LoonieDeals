...
ActiveRecord::Schema[7.0].define(version: 2023_04_21_215915) do
  ...
  create_table "balance_sheets", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["quote_id", "period", "calendar_year"], name: "index_balance_sheets_on_quote_id_and_period_and_calendar_year", unique: true
  ...
  create_table "cash_flows", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["quote_id", "period", "calendar_year"], name: "index_cash_flows_on_quote_id_and_period_and_calendar_year", unique: true
  ...
  create_table "financial_statements", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["quote_id", "period", "calendar_year"], name: "index_financial_statements_on_quote_period_year", unique: true
    t.index ["quote_id"], name: "index_financial_statements_on_quote_id"
  end

  create_table "holding_activities", force: :cascade do |t|
    t.integer "activity_type", limit: 1, default: 0
    t.integer "quantity"
    t.integer "reported_price_cents", default: 0
    t.float "percentage_change", default: 0.0
    t.integer "book_value_cents", default: 0
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["holding_id"], name: "index_holding_activities_on_holding_id"
  end
  ...
  create_table "holdings", force: :cascade do |t|
    ...
    t.integer "book_value_cents", default: 0
    t.integer "current_value_cents", default: 0
    t.decimal "percentage_of_portfolio", default: "0.0"
    t.integer "popular_investor_id", null: false
    t.integer "quote_id", null: false
    t.string "currency", default: "USD", null: false
    t.datetime "last_updated_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["popular_investor_id"], name: "index_holdings_on_popular_investor_id"
    t.index ["quote_id"], name: "index_holdings_on_quote_id"
  end
  ...
  create_table "income_statements", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["quote_id", "period", "calendar_year"], name: "index_income_statements_on_quote_id_and_period_and_calendar_year", unique: true
  ...
  create_table "monthly_prices", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["quote_id", "month", "year"], name: "index_monthly_prices_on_quote_id_and_month_and_year", unique: true
  ...
  create_table "popular_investors", force: :cascade do |t|
    ...
    t.text "bio"
    t.string "slug"
    t.integer "portfolio_book_value_cents", default: 0
    t.integer "portfolio_current_value_cents", default: 0
    t.string "currency", default: "USD", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_popular_investors_on_name", unique: true
    t.index ["slug"], name: "index_popular_investors_on_slug", unique: true
  end

  create_table "portfolio_activities", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["portfolio_id"], name: "index_portfolio_activities_on_portfolio_id"
  end
  ...
  create_table "quotes", force: :cascade do |t|
    ...
    t.date "#<ActiveRecord::ConnectionAdapters::SQLite3::TableDefinition:0x000000010e61e1a8>"
  ...
  create_table "yearly_prices", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["quote_id", "year"], name: "index_yearly_prices_on_quote_id_and_year", unique: true
  ...
  add_foreign_key "holding_activities", "holdings"
  add_foreign_key "holdings", "popular_investors"
  add_foreign_key "holdings", "quotes"
  ...
  add_foreign_key "portfolio_activities", "portfolios"
