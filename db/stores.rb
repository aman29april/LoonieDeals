...
[
  ...
  { name: 'PRESTO', logo: 'PRESTO.png', website: '' },
  { name: 'SBI Canada Bank', logo: 'SBI Canada Bank.jpeg', website: '' },
  { name: 'The North Face', logo: 'The North Face.png', website: '' },
  { name: 'Nordstrom', logo: 'Nordstrom.png', website: '' },
  { name: 'DC Shoes', logo: 'DC Shoes.png', website: '' },
  { name: 'Tommy Hilfiger', logo: 'Tommy Hilfiger.png', website: '' },
  { name: 'WebSaver', logo: 'WebSaver.png', website: '' },
  { name: 'T-Mobile', logo: 'T-Mobile.png', website: '' },
  { name: 'Swagbucks', logo: 'Swagbucks.png', website: '' },
  { name: 'Nintendo', logo: 'Nintendo.png', website: '' },
  { name: 'aloSIM', logo: 'aloSIM.png', website: '' },
  { name: 'Kitchen Stuff Plus', logo: 'Kitchen Stuff Plus.png', website: '' },
  { name: 'Book Outlet', logo: 'Book Outlet.png', website: '' },
  { name: 'DAVIDsTEA', logo: 'DAVIDsTEA.png', website: '' },
  { name: 'Famous Footwear', logo: 'Famous Footwear.png', website: '' },
  { name: 'G-SHOCK', logo: 'G-SHOCK.png', website: '' },
  { name: 'HomeSense', logo: 'HomeSense.png', website: '' },
  { name: 'Winners', logo: 'Winners.png', website: '' },
  { name: 'Marshalls', logo: 'Marshalls.png', website: '' },
  { name: "The Children's Place", logo: 'The Childrens Place.png', website: '' },
  { name: 'Gymboree', logo: 'Gymboree.png', website: '' },
  { name: 'SVP Sports', logo: 'SVP Sports.png', website: '' },
  { name: 'Oxford Mills - Beddington', logo: 'Beddington.png', website: '' },
  { name: 'Shein', logo: 'Shein.png', website: '' },
  { name: 'Revolution Nutriion', logo: 'Revolution Nutriion.png', website: '' },
  { name: 'My Protein', logo: 'My Protein.png', website: '' },
  { name: 'Chatime', logo: 'Chatime.png', website: '' },
