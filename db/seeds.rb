...
if Rails.env.development?
  AdminUser.create!(email: 'admin@example.com', password: 'password',
                    password_confirmation: 'password') unless AdminUser.find_by(email: 'admin@example.com').present?
...
stores.each do |store_data|
  ...
  store.image.attach(io: File.open(image), filename: filename)
  store.save!
...
deals.each do |deal_data|
  ...
  deal.image.attach(io: File.open(image), filename: filename)
  deal.save!
end
